...
import { getClassConstructorParams, capitalizeFirstLetter, getFunctionParams } from './utils';
...
const reconciler = ReactReconciler({
    ...
    */
    createInstance(type, props, rootContainer, hostContext, internalHandle) {
        ...
        const element = isConstructor ? new Class(...paramValues) : Class(...paramValues);
        // set non-constructor props
        Object.keys(props).filter((propName) => !paramNames.includes(propName)).forEach((key) => {
    ...
    */
    shouldSetTextContent(type, props) { return null },
    /*
    ...
    */
    ...
    prepareUpdate(instance, type, oldProps, newProps, rootContainer, hostContext) {
        ...
        console.log(`prepareUpdate ${type} - changes`, oldProps, newProps);
    ...
    */
    clearContainer(container) { return null },
    ...
    */
    preloadInstance(type, props) { return true; }, // Return true to indicate it's already loaded
