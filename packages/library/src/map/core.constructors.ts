const ConstructorsMap: Record<string, Array<string>> = {
    ...
    sprite: ['name', 'manager'],
    spriteManager: ['name', 'imgUrl', 'capacity', 'cellSize', 'scene', 'epsilon', 'samplingMode', 'fromPacked', 'spriteJSON'],
    spriteMap: ['name', 'atlasJSON', 'spriteSheet', 'options', 'scene'],
    spritePackedManager: ['name', 'imgUrl', 'capacity', 'scene', 'spriteJSON', 'epsilon', 'samplingMode'],
