const ConstructorsMap: Record<string, Array<string>> = {
   ...
   bloomEffect: ["scene","_bloomScale","bloomWeight","bloomKernel","pipelineTextureType","blockCompilation"],
   ...
   blurPostProcess: ["name","direction","kernel","options","camera","samplingMode","engine","reusable","textureType","defines","_blockCompilation","textureFormat"],
   ...
   screenshotUsingRenderTarget: ["engine","camera","size","successCallback","mimeType","samples","antialiasing","fileName","renderSprites","enableStencilBuffer","useLayerMask","quality","customizeTexture"],
   screenshotUsingRenderTargetAsync: ["engine","camera","size","mimeType","samples","antialiasing","fileName","renderSprites","enableStencilBuffer","useLayerMask","quality","customizeTexture"],
   ...
   depthOfFieldBlurPostProcess: ["name","scene","direction","kernel","options","camera","circleOfConfusion","imageToBlur","samplingMode","engine","reusable","textureType","blockCompilation","textureFormat"],
   depthOfFieldEffect: ["scene","depthTexture","blurLevel","pipelineTextureType","blockCompilation"],
   ...
   dynamicTexture: ["name","options","scene","generateMipMaps","samplingMode","format","invertY"],
   easingFunction: [],
   ...
   fadeInOutBehavior: [],
   filesInput: ["engine","scene","sceneLoadedCallback","progressCallback","additionalRenderLoopLogicCallback","textureLoadingCallback","startingProcessingFilesCallback","onReloadCallback","errorCallback","useAppend"],
   ...
   getHotSpotToRef: ["mesh","hotSpotQuery","res"],
   ...
   prepareUniformsAndSamplersForLight: ["lightIndex","uniformsList","samplersList","projectedLightTexture","uniformBuffersList","updateOnlyBuffersList"],
   ...
   pushMaterial: ["name","scene","storeEffectOnSubMeshes"],
