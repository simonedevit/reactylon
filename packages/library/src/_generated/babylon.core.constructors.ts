const ConstructorsMap: Record<string, Array<string>> = {
   ...
   prepareUniformsAndSamplersForLight: ["lightIndex","uniformsList","samplersList","projectedLightTexture","uniformBuffersList","updateOnlyBuffersList","iesLightTexture","clusteredLightTextures"],
