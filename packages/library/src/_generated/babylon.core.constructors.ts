const ConstructorsMap: Record<string, Array<string>> = {
   ...
   alignAngleBlock: ["name"],
   alignBlock: ["name"],
   alphaState: ["_supportBlendParametersPerTarget"],
   ambientOcclusionBlock: ["name"],
   ...
   animatorAvatar: ["name","rootNode","_disposeResources","setAvatarName"],
   ...
   areaLight: ["name","position","scene","dontAddToScene"],
   areaLightTextureTools: ["engine"],
   ...
   bindIBLParameters: ["scene","defines","ubo","reflectionColor","reflectionTexture","realTimeFiltering","supportTextureInfo","supportLocalProjection","usePBR","supportSH","useColor","reflectionBlur"],
   bindIBLSamplers: ["scene","defines","ubo","reflectionTexture","realTimeFiltering"],
   ...
   bindVertexPullingUniforms: ["effect","metadata"],
   bitArray: ["size"],
   ...
   clusteredLightContainer: ["name","lights","scene"],
   clusteredLightingSceneComponent: ["scene"],
   collider: [],
   color3: ["r","g","b"],
   ...
   computeLookAtFromYawPitchToRef: ["yaw","pitch","center","useRightHandedSystem","result","calculateUpVectorFromPointToRef"],
   ...
   computeYawPitchFromLookAtToRef: ["lookAt","center","useRightHandedSystem","currentYaw","result","calculateUpVectorFromPointToRef"],
   ...
   copyTextureToTexture: ["engine","isDepthTexture","sameSizeCopy"],
   ...
   screenshot: ["engine","camera","size","successCallback","mimeType","forceDownload","quality","useFill","clearWithSceneColor"],
   screenshotAsync: ["engine","camera","size","mimeType","quality","useFill","clearWithSceneColor","forceDownload"],
   screenshotForFrameGraphAsync: ["frameGraph","camera","size","mimeType","samples","antialiasing","fileName","quality","customDumpData","automaticDownload","numberOfFramesToRender"],
   screenshotUsingRenderTarget: ["engine","camera","size","successCallback","mimeType","samples","antialiasing","fileName","renderSprites","enableStencilBuffer","useLayerMask","quality","customizeTexture","customDumpData","timeoutInMilliseconds","timeoutErrorCallback"],
   ...
   skeletonFromTransformNodeHierarchy: ["rootNode","scene","options"],
   ...
   utilityLayerRenderer: ["frameFraph","handleEvents"],
   crossBlock: ["name"],
   ...
   cubeTextureAssetTask: ["name","url","extensionsOrOptions","noMipmap","files","prefiltered"],
   ...
   depthReducer: ["camera"],
   depthRenderer: ["scene","type","camera","storeNonLinearDepth","samplingMode","storeCameraSpaceZ","name","existingRenderTargetTexture"],
   depthRendererSceneComponent: ["scene"],
   depthSortedParticle: ["idx","ind","indLength","materialIndex"],
   depthSourceBlock: ["name"],
   ...
   directionalLight: ["name","direction","scene","dontAddToScene"],
   ...
   eXRCubeTexture: ["url","sceneOrEngine","size","noMipmap","generateHarmonics","gammaSpace","prefilterOnLoad","onLoad","onError","supersample","prefilterIrradianceOnLoad","prefilterUsingCdf"],
   easingFunction: [],
   ecefFromLatLonAltToRef: ["latLonAlt","ellipsoid","result"],
   ...
   envCubeTexture: ["url","sceneOrEngine","size","noMipmap","generateHarmonics","gammaSpace","prefilterOnLoad","onLoad","onError","supersample","prefilterIrradianceOnLoad","prefilterUsingCdf"],
   environmentHelper: ["options","scene"],
   equiRectangularCubeTexture: ["url","scene","size","noMipmap","gammaSpace","onLoad","onError","supersample"],
   equiRectangularCubeTextureAssetTask: ["name","url","size","noMipmap","gammaSpace","superSample"],
   ...
   findMainCamera: ["frameGraph"],
   findMainObjectRenderer: ["frameGraph"],
   ...
   frameGraphFilterTask: ["name","frameGraph","thinPostProcess"],
   frameGraphGenerateMipMapsTask: ["name","frameGraph"],
   frameGraphGeometryRendererTask: ["name","frameGraph","scene","options","existingObjectRenderer"],
   ...
   frameGraphLightingVolumeTask: ["name","frameGraph"],
   ...
   frameGraphSelectionOutlineLayerTask: ["name","frameGraph","scene","options"],
   ...
   frameGraphVolumetricLightingTask: ["name","frameGraph","enableExtinction"],
   framingBehavior: [],
   ...
   gaussianSplattingGpuPickingMaterialPlugin: ["material","maxPartCount"],
   gaussianSplattingMaterial: ["name","scene"],
   gaussianSplattingMesh: ["name","url","scene","keepInRam"],
   gaussianSplattingSolidColorMaterialPlugin: ["material","partColors","maxPartCount"],
   ...
   geometry: ["id","scene","vertexData","updatable","mesh","totalVertices"],
   ...
   getGaussianSplattingMaxPartCount: ["engine"],
   ...
   getTGAHeader: ["data"],
   getTextureDataAsync: ["texture","width","height","face","lod","forceRTT"],
   getTransformedPosition: ["mesh","index","res"],
   getTypeByteLength: ["type"],
   getTypedArrayConstructor: ["componentType"],
   getTypedArrayData: ["data","size","type","byteOffset","byteStride","totalVertices","forceCopy"],
   gizmo: ["gizmoLayer"],
   ...
   hDRCubeTextureAssetTask: ["name","url","size","noMipmap","generateHarmonics","gammaSpace","prefilterOnLoad","supersample","prefilterIrradianceOnLoad","prefilterUsingCdf"],
   ...
   isWindowObjectExist: [],
   isWrapper: ["effect"],
   kTX2InitializeWebWorker: ["worker","wasmBinaries","urls"],
   kTX2WorkerFunction: ["KTX2DecoderModule"],
   ...
   lastdAudioEngine: [],
   latLonFromDegreesToRef: ["lat","lon","result"],
   latLonToNormalToRef: ["latLon","result"],
   lattice: ["options"],
   latticeBlock: ["name"],
   ...
   lerpBlock: ["name"],
   light: ["name","scene","dontAddToScene"],
   lightBlock: ["name"],
   ...
   loadAssetContainerFromSerializedScene: ["scene","serializedScene","rootUrl"],
   loadFile: [],
   ...
   morphTarget: ["name","influence","scene","morphTargetManager"],
   morphTargetManager: ["scene","meshName"],
   ...
   nodeRenderGraphFilterPostProcessBlock: ["name","frameGraph","scene"],
   nodeRenderGraphGenerateMipmapsBlock: ["name","frameGraph","scene"],
   nodeRenderGraphGeometryRendererBlock: ["name","frameGraph","scene","doNotChangeAspectRatio","enableClusteredLights"],
   ...
   nodeRenderGraphLightingVolumeBlock: ["name","frameGraph","scene"],
   ...
   nodeRenderGraphSelectionOutlineLayerBlock: ["name","frameGraph","scene","layerTextureRatio","layerTextureFixedSize","layerTextureType"],
   ...
   nodeRenderGraphVolumetricLightingBlock: ["name","frameGraph","scene","enableExtinction"],
   noiseBlock: ["name"],
   ...
   openPBRMaterialDefines: ["externalProperties"],
   ...
   particleLocalVariableBlock: ["name"],
   particleMathBlock: ["name"],
   particleNLerpBlock: ["name"],
   particleNumberMathBlock: ["name"],
   particleRampGradientBlock: ["name"],
   particleRandomBlock: ["name"],
   particleSmoothStepBlock: ["name"],
   particleStepBlock: ["name"],
   particleSystem: [],
   particleSystemSet: [],
   ...
   particleVectorLengthBlock: ["name"],
   particleVectorMathBlock: ["name"],
   ...
   pointLight: ["name","position","scene","dontAddToScene"],
   pointListBlock: ["name"],
   ...
   prepareDefinesForIBL: ["scene","reflectionTexture","defines","realTimeFiltering","realTimeFilteringQuality","forceSHInVertex"],
   ...
   prepareDefinesForMisc: ["mesh","scene","useLogarithmicDepth","pointsCloud","fogEnabled","alphaTest","defines","applyDecalAfterDetail","useVertexPulling","renderingMesh","setVertexOutputInvariant"],
   ...
   prepareUniformLayoutForIBL: ["ubo","supportTextureInfo","supportLocalProjection","usePBR","supportSH","useColor"],
   prepareUniformsAndSamplersForIBL: ["uniformsList","samplersList","useSH"],
   prepareUniformsAndSamplersForLight: ["lightIndex","uniformsList","samplersList","projectedLightTexture","uniformBuffersList","updateOnlyBuffersList","iesLightTexture","clusteredLightTextures","rectAreaLightTexture"],
   prepareUniformsAndSamplersList: ["uniformsListOrOptions","samplersList","defines","maxSimultaneousLights"],
   prepareVertexPullingUniforms: ["geometry"],
   ...
   rawTexture: ["data","width","height","format","sceneOrEngine","generateMipMaps","invertY","samplingMode","type","creationFlags","useSRGBBuffer","waitDataToBeReady","mipLevelCount"],
   rawTexture2DArray: ["data","width","height","depth","format","scene","generateMipMaps","invertY","samplingMode","textureType","creationFlags","mipLevelCount"],
   ...
   rectAreaLight: ["name","position","width","height","scene","dontAddToScene"],
   reflectBlock: ["name"],
   ...
   selectionOutlineLayer: ["name","scene","options"],
   ...
   spotLight: ["name","position","direction","angle","exponent","scene","dontAddToScene"],
   ...
   staticSound: ["name","engine","options"],
   ...
   streamingSound: ["name","engine","options"],
   stringDictionary: [],
   ...
   textureAssetTask: ["name","url","noMipmapOrOptions","invertY","samplingMode"],
   ...
   thinColorCorrectionPostProcess: ["name","scene","colorTableUrl","options"],
   thinConvolutionPostProcess: ["name","engine","kernel","options"],
   thinDepthOfFieldEffect: ["name","engine","blurLevel","depthNotNormalized","blockCompilation"],
   thinDepthPeelingRenderer: ["scene","passCount"],
   ...
   thinFilterPostProcess: ["name","engine","options"],
   ...
   thinScreenSpaceCurvaturePostProcess: ["name","engine","options"],
   thinSelectionOutlineLayer: ["name","scene","options","dontCheckIfReady"],
   thinSharpenPostProcess: ["name","engine","options"],
   thinTexture: ["internalTexture"],
   thinTonemapPostProcess: ["name","engine","options"],
   toHalfFloat: ["value"],
   toHex: ["i"],
   tonemapPostProcess: ["name","operator","exposureAdjustment","camera","samplingMode","engine","textureType","reusable"],
   torusBlock: ["name"],
   ...
   vector3SignedDistanceToPlaneFromPositionAndNormal: ["origin","normal","point"],
   ...
   webGPUDrawContext: ["bufferManager","_dummyIndexBuffer"],
   ...
   webXROculusHandController: ["scene","gamepadObject","handedness"],
   ...
   _IESTextureLoader: [],
   _InstancesBatch: ["parent"],
   _KTXTextureLoader: [],
   _LoadScriptModuleAsync: ["scriptUrl","scriptId"],
   _MeshCollisionData: [],
   ...
   _injectLTSFileTools: [],
   addAccessorsForMaterialProperty: ["setCallback","targetKey"],
