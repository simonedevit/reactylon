const ConstructorsMap: Record<string, Array<string>> = {
   ...
   animatorAvatar: ["name","rootNode","_disposeResources"],
   ...
   computeLookAtFromYawPitchToRef: ["yaw","pitch","center","useRightHandedSystem","result"],
   ...
   computeYawPitchFromLookAtToRef: ["lookAt","center","useRightHandedSystem","currentYaw","result"],
